<?php
   ...
   */
   ...
   define( 'K_DB_NAME', 'web93-coast' );
   // 5.
   // Database username
   define( 'K_DB_USER', 'web93-coast' );
   // 6.
   // Database password 
   define( 'K_DB_PASSWORD', 'coast123!' );
   // 7.
   ...
   define( 'K_DB_TABLES_PREFIX', 'cms_' );        
   ...
   define( 'K_EMAIL_TO', 'coastdentalhealth@gmail.com' );

   // 14.
   // Will be used as the sender of messages delivered by contact forms to the address above.
   define( 'K_EMAIL_FROM', 'coastdentalhealth@gmail.com' );
