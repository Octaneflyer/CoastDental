...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"kenburns",prev:"prev",next:"next",duration:20*100,delay:20*100,outWidth:1024,outHeight:400,width:1024,height:400,autoPlay:true,stopOnHover:false,loop:false,bullets:0,caption:true,controls:false});